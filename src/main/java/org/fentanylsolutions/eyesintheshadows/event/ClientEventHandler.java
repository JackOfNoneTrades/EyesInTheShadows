    ...
    public void ontick(TickEvent.PlayerTickEvent e) {
        if (EyesInTheShadows.isDebugMode()) {
            if (Keyboard.isKeyDown(Keyboard.KEY_R)) {
                 ...
                 * EyesInTheShadows.debug("Block name: " + b.getLocalizedName() + ", x: " + x + ", y: " + y + ", z :" +
                 * z);
                 * EyesInTheShadows.debug("Block lightvalue: " + b.getLightValue());
                 * EyesInTheShadows.debug("world.getBlockLightValue: " + e.player.getEntityWorld().getBlockLightValue(x,
                 * y, z));
                 * EyesInTheShadows.debug("world.getBlockLightValue_do: " +
                 * e.player.getEntityWorld().getBlockLightValue_do(x, y, z, false));
                 * EyesInTheShadows.debug("world.getFullBlockLightValue: " +
                 * e.player.getEntityWorld().getFullBlockLightValue(x, y, z));
                 * EyesInTheShadows.debug("world.getLightBrightness: " + e.player.getEntityWorld().getLightBrightness(x,
                 * y, z));
                 * EyesInTheShadows.debug("world.getSavedLightValue: " +
                 * e.player.getEntityWorld().getSavedLightValue(EnumSkyBlock.Block, x, y, z));
