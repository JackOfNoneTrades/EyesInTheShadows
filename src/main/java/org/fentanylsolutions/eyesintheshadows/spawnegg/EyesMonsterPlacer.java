package org.fentanylsolutions.eyesintheshadows.spawnegg;
...
public class EyesMonsterPlacer extends ItemMonsterPlacer {
    ...
    public EyesMonsterPlacer() {
        super();
    }

    public EyesMonsterPlacer(String parEntityToSpawnName, int parPrimaryColor, int parSecondaryColor) {
        ...
        EyesInTheShadows.debug("Spawn egg constructor for " + entityToSpawnName);
    }
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ) {
        ...
        {
            entityToSpawnNameFull = EyesInTheShadows.MODID + "." + entityToSpawnName;
            if (EntityList.stringToClassMapping.containsKey(entityToSpawnNameFull)) {
                ...
                EyesInTheShadows.LOG.error("Entity not found: " + entityToSpawnName);
            }
        }
    ...
    public IIcon getIconFromDamageForRenderPass(int parDamageVal, int parRenderPass) {
        return parRenderPass > 0 ? theIcon
            : super.getIconFromDamageForRenderPass(
                parDamageVal,
