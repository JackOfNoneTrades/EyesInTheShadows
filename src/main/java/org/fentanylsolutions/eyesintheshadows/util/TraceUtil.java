...
public class TraceUtil {
    ...
    public static boolean canEntityBeSeenIgnoreWithoutBoundingBox(EntityPlayer player, Entity entity) {
        Vec3 eyePos = Vec3.createVectorHelper(player.posX, player.posY + (double)player.getEyeHeight(), player.posZ);
        Vec3 targetPos = Vec3.createVectorHelper(entity.posX, entity.posY + (double)entity.getEyeHeight(), entity.posZ);
